...
-->
<template>
    <div class="bg-gray-100 pb-8 sm:pb-12 lg:pb-12">
        <div class="pt-8 overflow-hidden sm:pt-12 lg:relative lg:py-48">
            <div class="container lg:grid lg:grid-cols-2 lg:gap-24">
                <div>
                    <div>
                    ...
                    <div class="mt-12">
                        <div>
                            <a href="#" class="inline-flex space-x-4">
                                <span class="rounded bg-indigo-100 px-2.5 py-1 text-xs font-semibold text-indigo-600 tracking-wide uppercase"> Save Money </span>
                            </a>
                        </div>
                        <div class="mt-6 sm:max-w-xl">
                            <h1 class="text-4xl font-extrabold text-gray-900 tracking-tight sm:text-5xl">Reduce costs and maintenance with serverless</h1>
            ...
            <div class="sm:mx-auto sm:max-w-3xl sm:px-6">
                <div class="py-12 sm:relative sm:mt-12 sm:py-16 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
                    <div class="hidden sm:block">
                        <div class="absolute inset-y-0 left-1/2 w-screen bg-gray-200 rounded-l-3xl lg:left-80 lg:right-0 lg:w-full" />
